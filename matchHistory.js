...
.then(data => {
    ...
    data.forEach(element => {
        ...
        match.innerHTML='<span class="row justify-content-center"><span class="col-md text-nowrap"><img src="https://storage.googleapis.com/' + element.team1.logo + '" alt="team1 logo" class="teamlogo">' +
                        '<span class="teamName fw-bold"> ' + element.team1.name + '</span></span>' +
                        '<span class="col-md text-nowrap">' + score1 + '-' + score2 + '</span>'  +
                        '<span class="col-md text-nowrap"><span class="teamName fw-bold">' + element.team2.name + ' </span>' +
